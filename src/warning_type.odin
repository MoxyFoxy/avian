...
Warnings :: enum {
    ...
    P_UNEXPECTED_KEYWORD, P_PROC_UNEXPECTED_TOKEN, P_PARAM_MISSING_NAME,
    P_PARAM_MISSING_COLON, P_UNEXPECTED_TYPE_NAME, P_PARAM_UNEXPECTED_TOKEN,
    P_INVALID_RETURN_TYPE, P_RETURN_UNEXPECTED_TOKEN,
}
